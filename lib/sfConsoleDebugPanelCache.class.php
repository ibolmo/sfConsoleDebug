...
class sfConsoleDebugPanelCache extends sfWebDebugPanelCache
{
	...
	public static function decorateContentWithDebug(sfEvent $event, $content)
	{
		...
		if (!sfConfig::get('sf_web_debug') || !$content || false === strpos($event['response']->getContentType(), 'html')) return $content;
